...
class SaleReport(models.Model):
    ...
    def _select(self):
        return super(SaleReport, self)._select() + ", s.mk_instance_id as mk_instance_id, mk.marketplace as marketplace_type, sum((CASE WHEN l.is_delivery THEN l.price_total ELSE 0.0 END)) AS delivery_amount, t.type as product_type"
    
    def _group_by(self):
        return super(SaleReport, self)._group_by() + ", s.mk_instance_id, mk.marketplace, t.type"
    ...
    def redirect_to_mk_sale_report(self):
        ...
        if odoo_version['server_version'] == '11.0+e':
